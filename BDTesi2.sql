...
CREATE TABLE MONSTER (
    ...
    CLASS VARCHAR (20),
    FOREIGN KEY CLASS(CLASS) REFERENCES CLASSES(CLASS),	/*MELEE, RANGED, MIX? */
...
CREATE TABLE SUPPLIES_OWNED (
	S_NAME VARCHAR (20),
    FOREIGN KEY S_NAME(S_NAME) REFERENCES SUPPLIES(S_NAME),
	S_QUANTITY INT NOT NULL DEFAULT 1,
    ID_OWNER VARCHAR (20),
    FOREIGN KEY ID_OWNER(ID_OWNER) REFERENCES USER(ID),
...
CREATE TABLE WEARABLE_OWNED (
	W_NAME VARCHAR(20),
	FOREIGN KEY W_NAME(W_NAME) references WEARABLE(W_NAME),
...
CREATE TABLE EQUIPPED (
	COD_M INT(20),
    FOREIGN KEY COD_M(COD_M) references MONSTER_OWNED(COD_M),
	W_NAME VARCHAR (20),
    FOREIGN KEY W_NAME(W_NAME) references WEARABLE(W_NAME),
    W_TYPE VARCHAR(20) REFERENCES WEARABLE(W_TYPE),
    
    PRIMARY KEY (COD_M, W_NAME),
    UNIQUE KEY (COD_M, W_TYPE)
);
...
CREATE TABLE ABILITY (
    ...
    A_CLASS VARCHAR (20),
    FOREIGN KEY A_CLASS(A_CLASS) REFERENCES CLASSES(CLASS),
...
CREATE TABLE MONSTER_OWNED (
    ...
    FOREIGN KEY DENOMINATION(DENOMINATION) REFERENCES MONSTER(DENOMINATION),
    NAME VARCHAR (20),
...
CREATE TABLE MONSTER_ABILITY (
    ...
    FOREIGN KEY COD_M(COD_M) REFERENCES MONSTER_OWNED(COD_M),
	A_NAME VARCHAR (20),
    FOREIGN KEY A_NAME(A_NAME) REFERENCES ABILITY(A_NAME),
...
CREATE TABLE TEAM (						/* Da 0 a 9 istanze per ogni user (vincolo java) */
	ID_USER VARCHAR(20),
    FOREIGN KEY ID_USER(ID_USER) REFERENCES USER(ID),
	COD_M INT,
    FOREIGN KEY COD_M(COD_M) REFERENCES MONSTER_OWNED(COD_M),		/* DA VINCOLARE (SCELTA SOLO TRA MOSTRI POSSEDUTI) IN JAVA*/
...
CREATE TABLE MONSTER_ACTION (
	COD_M INT,
    FOREIGN KEY COD_M(COD_M) REFERENCES MONSTER_FIGHTING(COD_M),
...
INSERT INTO EQUIPPED VALUES (3, 'Spada del vento', 'weapon');
